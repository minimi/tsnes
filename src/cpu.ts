...
export namespace CPU {
  ...
  export class CPU {
    ...
    private F_DECIMAL = null;
    private F_INTERRUPT = null;
    private F_INTERRUPT_NEW = null;
    private F_OVERFLOW = null;
    private F_SIGN = null;
    private F_ZERO = null;
    private F_NOTUSED = null;
    private F_NOTUSED_NEW = null;
    private F_BRK = null;
    private F_BRK_NEW = null;
    private opdata = null;
    private cyclesToHalt = null;
    private crash = null;
    private irqRequested = null;
    private irqType = null;

    // IRQ Types
    private readonly IRQ_NORMAL = 0;
    private readonly IRQ_NMI = 1;
    private readonly IRQ_RESET = 2;
