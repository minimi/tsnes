...
export namespace PPU {

  export let PPU = function (nes) {
    this.nes = nes;
  ...
  PPU.prototype = {
    ...
    toJSON: function () {
      let i;
      let state = Utils.toJSON(this) as any;
  ...
  export let NameTable = function (width, height, name) {
    this.width = width;
    this.height = height;
    this.name = name;
  ...
  export let PaletteTable = function () {
